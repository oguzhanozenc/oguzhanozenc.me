        ...
        <div className="about-container">
          ...
          <div className="about-grid">
            <div className="aboutme-text">
              <p>
                I am a Front-End Developer with a strong foundation in HTML,
                CSS, JavaScript, and React, driven by a passion for design and
          ...
          <div className="aboutme-text">
            ...
            <p>
              ...
              dynamic and responsive user interfaces, I aim to develop an
              engaging web application with seamless navigation. I integrated
              and customized a CMS for efficient content management and seamless
            ...
            <p>
              ...
              in Management Information Systems at Anadolu University, I've
              gained skills that have enabled me to tackle complex problems and
            ...
            <p>
              ...
              journey into software development was a perfect opportunity for
              me. During my time at Beko Corporate, I applied agile
              methodologies for sustainable product development, researched
              emerging technologies, and established strategic collaborations,
              contributing to impactful innovation initiatives.
            </p>
            <p>
              ...
              technologies in a collaborative environment that values
              creativity, user experience, and impactful solutions.
            </p>
          </div>{" "}
          <div>
            <LetsWork />
